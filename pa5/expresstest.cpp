...
void test2() {
    ...
    cin >> x >> y;
    ExpressionTree e1(x), e2(y);
    cout << "success 1" << endl;
    ExpressionTree sum = e1 + e2;
    cout << "success 2" << endl;
...
ExpressionTree buildComplex() {
    ...
    ExpressionTree ex(x), ey(y), ez(z), e2(2),
        ...
        sum1 = ex + yz,
        full = sum1 + y2;
    cout << "yz: " << yz.evaluate() << endl;
    cout << "y2: " << y2.evaluate() << endl;
    cout << "sum1: " << sum1.evaluate() << endl;
    cout << "full: " << full.evaluate() << endl;
    return full;
}
